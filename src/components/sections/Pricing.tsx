    ...
    <section id="pricing" className="relative px-6 py-24 md:px-12 md:py-32 lg:px-20 stipple overflow-hidden">
      ...
      <div ref={ref} className="mx-auto max-w-6xl">
        ...
        >
          ...
          {/* The Concierge */}
          <div className="relative bg-white border border-neutral-200 rounded-2xl p-6 md:p-8">
            <span className="absolute top-0 right-8 -translate-y-1/2 bg-neutral-900 text-white text-sm px-4 py-1.5 rounded-full z-10">
              Limited slots
            </span>
            <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-neutral-500 mb-4 max-w-lg">
                  We apply to startups every weekday catered to your profile throughout the week, as soon as we hear of funding news. Resume review by real recruiters. Weekly check-ins over text. Full platform access.
                </p>
