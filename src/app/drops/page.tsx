        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-2 mb-6">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <span className="text-xs text-neutral-400">Mar 14</span>
              {!isPaid && (
          ...
          <h3 className="relative z-10 font-serif text-3xl sm:text-4xl text-neutral-900 mb-3">3 Startups · $8.8M+ Raised · Scorecards · Playbooks</h3>
          <p className="relative z-10 text-neutral-500 mb-6 max-w-2xl">
            Contextual intelligence for AI agents, AI-native customer support agency, and AI agent for video editors. Fresh raises with founder intel and outreach playbooks.
          </p>
          <div className="relative z-10 flex flex-wrap gap-3 mb-6">
