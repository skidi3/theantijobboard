  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-2 mb-6">
            ...
            <div className="flex items-center gap-2 ml-auto">
              <span className="text-xs font-medium text-rose-500 bg-rose-50 px-2.5 py-1 rounded-full">Sun</span>
              <span className="text-xs text-neutral-400">Feb 23</span>
              {!isPaid && (
        ...
        {/* Previous Drop */}
        <p className="text-sm text-white/80 uppercase tracking-wider mb-4">Previous Drop</p>
        <Link
          href="/drops/drop-001"
          className="group relative block bg-white border border-neutral-200 rounded-2xl p-6 md:p-8 mb-8 hover:border-neutral-300 transition-colors overflow-hidden"
        >
