    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="relative z-10 text-neutral-500 mb-6 max-w-2xl">
            AI governance for enterprise, semantic engineering for AI reliability, and agentic AI for corporate travel. Fresh raises with founder intel and outreach playbooks.
          </p>
          <div className="relative z-10 flex flex-wrap gap-3 mb-6">
